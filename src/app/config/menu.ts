...
const menuNav: Menu[] = [
  ...
  },
  {
    ...
    selected: false,
    menuType: 'C',
    path: '/sand-box/sand-account',
    code: 'R00',
    children: [
      {
        id: 1,
        fatherId: 2,
        menuName: 'DID generation',
        open: false,
        selected: false,
        menuType: 'C',
        code: 'R00',
        path: '/sand-box/sand-account/generation'
      },
      {
        id: 2,
        fatherId: 2,
        ...
        menuType: 'C',
        code: 'R00',
        path: '/sand-box/sand-account/upload'
      },
      {
        id: 3,
        fatherId: 2,
        menuName: 'Link Digital Currency Account to DID',
        open: false,
        selected: false,
        menuType: 'C',
        code: 'R00',
        path: '/sand-box/sand-account/digital'
      },
      {
        id: 4,
        fatherId: 2,
        menuName: 'Link UDPN DID to Business Account',
        open: false,
        selected: false,
        menuType: 'C',
        code: 'R00',
        path: '/sand-box/sand-account/business'
      },
    ]
  },
  {
    menuName: 'Transaction Management',
    id: 3,
    fatherId: 0,
    icon: 'wallet',
    open: false,
    selected: false,
    menuType: 'C',
    path: '/sand-box/sand-transaction',
    code: 'R00',
    children: [
      {
        id: 1,
        ...
        menuType: 'C',
        code: 'R00',
        path: '/sand-box/sand-transaction/transfer'
      },
      {
        id: 2,
        fatherId: 3,
        ...
        menuType: 'C',
        code: 'R00',
        path: '/sand-box/sand-transaction/swap'
      },
      {
        id: 3,
        fatherId: 3,
        menuName: 'Transactions Search',
        open: false,
        selected: false,
        menuType: 'C',
        code: 'R00',
        path: '/sand-box/sand-transaction/transactions'
      },
      {
        id: 4,
        fatherId: 3,
        menuName: 'Search by Transaction Key',
        open: false,
        selected: false,
        menuType: 'C',
        code: 'R00',
        path: '/sand-box/sand-transaction/search'
      },
      {
        id: 5,
        fatherId: 3,
        ...
        menuType: 'C',
        code: 'R00',
        path: '/sand-box/sand-transaction/analysis'
      },
    ]
  },
  {
    menuName: 'Network Access Configuration',
    id:4,
    fatherId: 0,
    icon: 'appstore',
    open: false,
    selected: false,
    menuType: 'C',
    path: '/sand-box/sand-network',
    code: 'R00',
    children: [
      {
        id: 1,
        fatherId: 4,
        menuName: 'BN Onboarding and Configuration',
        open: false,
        selected: false,
        menuType: 'C',
        code: 'R00',
        path: '/sand-box/sand-network/onboard'
      },
      {
        id: 2,
        fatherId: 4,
        menuName: 'Access Digital Currencies',
        open: false,
        selected: false,
        menuType: 'C',
        code: 'R00',
        path: '/sand-box/sand-network/currency'
      },
    ]
  },
  {
    menuName: 'Contract Deployment',
    id: 5,
    fatherId: 0,
    icon: 'sliders',
    open: false,
    selected: false,
    menuType: 'C',
    path: '/sand-box/sand-contract/contract',
    code: 'R00',
  },
  // {
  //   menuName: 'Contact US',
  ...
  //   selected: false,
  //   menuType: 'C',
  //   path: '/sand-box/sand-contact/contact',
  //   code: 'R00',
  // },
];